  ...
  <!-- <img src='wallpaper.jpg' style='position:fixed;top:0px;left:0px;width:100%;height:100%;z-index:-1;opacity:0.3;'> -->
   ...
   <div class="container">
      <div class="section">
         <div class="row">
            <div class="row">
            <p>This Web App is developped using PHP, MySQL, HTML, CSS, JS and Bootstrap (For Templates)  to test our CICD Pipeline, with a potential inclusion of DevSecOps later</p>
         </div>
      </div>
   </div>
   </div>
         ...
         <div class="row">
            ...
            <div class="col l3 s12">
               ...
               <ul>
                  ...
                  <li><a class="white-text">Responsive Design (Template used form quora)</a></li>
